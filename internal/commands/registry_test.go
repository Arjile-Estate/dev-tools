...
func TestGetBuiltInCommandNames(t *testing.T) {
	...
	expectedCommands := []string{"logs", "status", "cleanup-pids", "cleanup-all", "restart", "stop", "version", "completion"}
...
func TestGetBuiltInCommandMap(t *testing.T) {
	...
	expectedCommands := []string{"logs", "status", "cleanup-pids", "cleanup-all", "restart", "stop", "version", "completion", "__dev_complete"}
